...
3. **Verificar se o modulo esta carregado**:
   ...
   Se o modulo estiver carregado corretamente, voco vera /proc/pid Criado como um modulo carregado.
...
1. **Escrever um valor no /proc/pid**:
    ...
    ```bash    echo "copie o numero aqui" > /proc/pid    ```
...
**Verificar se o modulo foi descarregado**:
   ...
   Se o modulo estiver carregado corretamente, voce vera /proc/pid Removido como um modulo carregado.
