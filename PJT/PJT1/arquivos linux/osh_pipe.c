...
#define MAX_LINE 80 /* O comprimento máximo do comando */
    ...
    while (should_run) {
        ...
        for (int j = 0; j < i; j++) {
            if (args[j] != NULL && strcmp(args[j], ">") == 0) {
                if (args[j + 1] != NULL) {
                    ...
                    if (output_fd < 0) {
                        perror("Erro ao abrir arquivo para redirecionamento de saída");
                        output_redirected = 0; // Se não abrir, reseta
                    } else {
            ...
            if (args[j] != NULL && strcmp(args[j], "<") == 0) {
                if (args[j + 1] != NULL) {
                    ...
                    if (input_fd < 0) {
                        ...
                        input_redirected = 0; // Se não abrir, reseta
                    } else {
        ...
        if (pipe_index != -1) {
            ...
            if (pid1 < 0) {
                perror("Fork failed");
                return 1;
            } else if (pid1 == 0) { // Código do primeiro filho
            ...
            if (pid2 < 0) {
                perror("Fork failed");
                return 1;
            } else if (pid2 == 0) { // Código do segundo filho
